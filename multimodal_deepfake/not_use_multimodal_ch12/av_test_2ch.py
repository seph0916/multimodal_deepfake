...
multi_test_loader=DataLoader(padded_data, batch_size=2, shuffle=True, drop_last=True)


path="/data1/josephlee/multimodal/best_model/avceleb_two_ch_best_model/2024_0326_avdata_twoloss_2ch_multimodal.pth"
