...
class WaveLSTM(nn.Module):
    def __init__(
        self,num_frames: int, input_len: int, hidden_dim: int, out_dim: int, **kwargs,):
...
if __name__ == "__main__":
    ...
    model = WaveLSTM(num_frames=10, input_len=176490, hidden_dim=30, out_dim=1) # 원래는 input_len=64600
