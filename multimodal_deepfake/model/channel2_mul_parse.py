...
class Multimodal(nn.Module):
    def __init__(self,in_channels=50, num_frames=10, input_len=96000, hidden_dim=30, out_dim=30 ):
        ...
        # #6초일때
        # self.audio_layer_TSSD=nn.Sequential(nn.Conv1d(in_channels=2, out_channels=16, kernel_size=7, padding=3, bias=False),
        #                                     nn.BatchNorm1d(16),
        #                                     nn.ReLU(),
        ...
        self.audio_layer_TSSD=nn.Sequential(nn.Conv1d(in_channels=2, out_channels=16, kernel_size=7, padding=3, bias=False),
                                            ...
                                            nn.MaxPool1d(kernel_size=4),
                                            RSM1D(channels_in=128,channels_out=128),
                                            nn.MaxPool1d(kernel_size=625), #1875 10초는 625
                                            nn.Flatten(start_dim=1),
                                            nn.Linear(in_features=128,out_features=64),
                                            nn.ReLU(),
                                            nn.Linear(64,30),
        ...
        self.fc1 = nn.Linear(7424,128) #7424 #12544 #38144
...
# audio_input=torch.rand(16, 2, 40, 481)
# model=Multimodal()
# a,b,c=model(image_model="CNN", audio_model="CNN", image_input=image_input, audio_input=audio_input)
# print("aaa")
